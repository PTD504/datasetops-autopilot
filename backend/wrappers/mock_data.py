...
VIETNAMESE_BENCHMARK_SAMPLES = [
    ...
    },
    {
        ...
        "expected_answer": "Hiện tại không hỗ trợ giao hàng quốc tế, nên bạn không thể đặt hàng nếu ở Campuchia.",
    ...
    },
    {
        "category": "warranty",
        "difficulty": "hard",
        "question": "Để yêu cầu bảo hành, tôi cần mang theo những gì?",
        "expected_answer": "Khách hàng phải xuất trình hóa đơn mua hàng hợp lệ hoặc xác nhận đơn hàng khi yêu cầu dịch vụ bảo hành.",
        "source_chunk_ids": ["mock_chunk_warranty_003"]
    },
    {
